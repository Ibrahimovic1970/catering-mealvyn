...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/pesanan/success/{id}', [CartController::class, 'success'])->name('pages.order-success');
...
Route::middleware(['auth', 'role:admin,ceo'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/pemesanan/{id}/update-shipping', [PemesananController::class, 'updateShipping'])->name('pemesanan.updateShipping');
